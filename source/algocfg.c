...
const struct algocfg ALGOCFGS[] = {
  ...
  [_FAOSO6] = {_FAOSO6, FAIL, FAIL, UNSATISFIABLE, 7, 0, 256, 256, 0, 0},
  ...
  [_FS_W8] = {_FS_W8, GOOD, RNDCRASH, UNSATISFIABLE, 0, 0, 256, 256, 0, 0}, // needs m space at the end of T
  [_FSBNDM_W1] = {_FSBNDM_W1, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 256, 0, 0},
  [_FSBNDM_W2] = {_FSBNDM_W2, ASSERTS, RNDCRASH, UNSATISFIABLE, 2, 0, 256, 256, 0, 0},
  ...
  [_TSA]    = {_TSA, GOOD, ASAN, UNSATISFIABLE, 2, 0, 360, 0, 0, 0},
  ...
  [_LIBC]  = {_LIBC, FAIL, ASAN, UNSATISFIABLE, 0, 0, 360, 0, 0, 0}, // no \0
