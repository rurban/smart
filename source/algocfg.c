...
const struct algocfg ALGOCFGS[] = {
  ...
  [_SHC4] =  {_SHC4,  FAIL, ASAN, VFY_PASS, 4, 0, 0, 0, 0, 0},
  [_SHC5] =  {_SHC5,  FAIL, ASAN, VFY_PASS, 5, 0, 0, 0, 0, 0},
  [_SHC6] =  {_SHC6,  FAIL, ASAN, VFY_PASS, 6, 0, 0, 0, 0, 0},
  [_SHC7] =  {_SHC7,  FAIL, ASAN, VFY_PASS, 7, 0, 0, 0, 0, 0},
  [_SHC8] =  {_SHC8,  FAIL, ASAN, VFY_PASS, 8, 0, 0, 0, 0, 0},
