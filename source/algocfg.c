...
const struct algocfg ALGOCFGS[] = {
  ...
  [_FS_W8] = {_FS_W8, GOOD, ASAN, VFY_PASS, 10, 0, 0, 0, 0, 0}, // needs m space at the end of T
  ...
  [_SBNDM_W2] = {_SBNDM_W2, FAIL, FAIL, VFY_PASS, 2, 32, 0, 0, 0, 0},
  ...
  [_TSA]    = {_TSA, ASSERTS, FAIL, VFY_PASS, 2, 63, 0, 0, 0, 0},
  ...
  [_TVSBS_W6] = {_TVSBS_W6, GOOD, FAIL, VFY_PASS, 2, XSIZE, 0, 0, 0, 0},
