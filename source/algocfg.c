...
const struct algocfg ALGOCFGS[] = {
  ...
  [_BF] = {_BF, GOOD, ASAN, UNSATISFIABLE, 0, 0, 320, 0},
  [_MP] = {_MP, GOOD, ASAN, VFY_PASS, 0, 0, 512, 0}, // 3m
  [_KMP] = {_KMP, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_BM] = {_BM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 320, 0},
  [_HOR] = {_HOR, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_GS] = {_GS, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_AG] = {_AG, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_KR] = {_KR, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_ZT] = {_ZT, GOOD, ASAN, VFY_PASS, 2, 0, 256, 256},
  [_AC] = {_AC, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  ...
  [_TBM] = {_TBM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_Colussi] = {_Colussi, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_Smith] = {_Smith, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_GG] = {_GG, FAIL, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  ...
  [_Skip] = {_Skip, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_KMPSkip] = {_KMPSkip, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_ASkip] = {_ASkip, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_BR] = {_BR, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_AKC] = {_AKC, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_FS] = {_FS, GOOD, ASAN, VFY_FAIL, 0, 0, 256, 256},
  [_FFS] = {_FFS, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_BFS] = {_BFS, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  ...
  [_GRASPm] = {_GRASPm, FAIL, FAIL, UNSATISFIABLE, 0, 0, 256, 0},
  [_SSEF] = {_SSEF, X64_ONLY, FAIL, UNSATISFIABLE, 32, 0, 256, 0},
  [_AUT] = {_AUT, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_RF] = {_RF, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_TRF] = {_TRF, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_Simon] = {_Simon, FAIL, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_FDM] = {_FDM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_BOM] = {_BOM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_BOM2] = {_BOM2, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_DFDM] = {_DFDM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_WW] = {_WW, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_LDM] = {_LDM, FAIL, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_ILDM1] = {_ILDM1, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_ILDM2] = {_ILDM2, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_EBOM] = {_EBOM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_FBOM] = {_FBOM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_SEBOM] = {_SEBOM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  [_SFBOM] = {_SFBOM, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  //[_SBDM] = {_SBDM, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  //[_BSOM] = {_BSOM, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_SKIP2] = {_SKIP2, GOOD, ASAN, VFY_TIMEOUT, 2, 0, 256, 0},
  [_SKIP3] = {_SKIP3, GOOD, ASAN, VFY_TIMEOUT, 3, 0, 256, 0},
  [_SKIP4] = {_SKIP4, GOOD, ASAN, VFY_TIMEOUT, 4, 0, 256, 0},
  [_SKIP5] = {_SKIP5, GOOD, ASAN, UNSATISFIABLE, 5, 0, 256, 0},
  [_SKIP6] = {_SKIP6, GOOD, ASAN, UNSATISFIABLE, 6, 0, 256, 0},
  [_SKIP7] = {_SKIP7, GOOD, ASAN, UNSATISFIABLE, 7, 0, 256, 0},
  [_SKIP8] = {_SKIP8, GOOD, ASAN, UNSATISFIABLE, 8, 0, 256, 0},
  ...
  [_BNDML] = {_BNDML, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  ...
  [_BMH_SBNDM] = {_BMH_SBNDM, FAIL, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_FNDM]  = {_FNDM, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_BWW]   = {_BWW, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  ...
  [_AOSO2] = {_AOSO2, GOOD, ASAN, UNSATISFIABLE, 3, 0, 256, 0},
  [_AOSO4] = {_AOSO4, GOOD, ASAN, UNSATISFIABLE, 5, 0, 256, 0},
  [_AOSO6] = {_AOSO6, GOOD, ASAN, UNSATISFIABLE, 7, 0, 256, 0},
  [_BLIM]  = {_BLIM, FAIL, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_FSBNDM] = {_FSBNDM, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_BNDMq2] = {_BNDMq2, GOOD, ASAN, UNSATISFIABLE, 2, 0, 256, 0},
  [_BNDMq4] = {_BNDMq4, GOOD, FAIL, UNSATISFIABLE, 4, 0, 256, 0},
  [_BNDMq6] = {_BNDMq6, GOOD, FAIL, UNSATISFIABLE, 6, 0, 256, 0},
  ...
  [_KSA]   = {_KSA, GOOD, ASAN, VFY_FAIL, 0, 0, 256, 256},
  [_KBNDM] = {_KBNDM, GOOD, ASAN, VFY_FAIL, 0, 0, 256, 256},
  [_BSDM]  = {_BSDM, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_BSDM2] = {_BSDM2, GOOD, ASAN, VFY_FAIL, 2, 0, 256, 256},
  [_BSDM3] = {_BSDM3, GOOD, ASAN, VFY_TIMEOUT, 3, 0, 256, 0},
  [_BSDM4] = {_BSDM4, GOOD, ASAN, VFY_TIMEOUT, 4, 0, 256, 0},
  [_BSDM5] = {_BSDM5, GOOD, ASAN, VFY_TIMEOUT, 5, 0, 256, 0},
  [_BSDM6] = {_BSDM6, GOOD, ASAN, UNSATISFIABLE, 6, 0, 256, 0},
  [_BSDM7] = {_BSDM7, GOOD, ASAN, VFY_TIMEOUT, 7, 0, 256, 0},
  [_BSDM8] = {_BSDM8, GOOD, ASAN, UNSATISFIABLE, 8, 0, 256, 0},
  [_BXS]  = {_BXS,  GOOD, ASAN, UNSATISFIABLE, 2, 0, 360, 0},
  [_BXS1] = {_BXS1, GOOD, ASAN, UNSATISFIABLE, 0, 0, 320, 0},
  [_BXS2] = {_BXS2, GOOD, ASAN, UNSATISFIABLE, 3, 0, 256, 0},
  [_BXS3] = {_BXS3, GOOD, ASAN, UNSATISFIABLE, 3, 0, 256, 0},
  [_BXS4] = {_BXS4, GOOD, ASAN, UNSATISFIABLE, 4, 0, 256, 0},
  [_BXS6] = {_BXS6, GOOD, ASAN, UNSATISFIABLE, 6, 0, 256, 0},
  [_BXS8] = {_BXS8, GOOD, ASAN, UNSATISFIABLE, 8, 0, 256, 0},
  ...
  [_FSBNDMQ21] = {_FSBNDMQ21, GOOD, ASAN, UNSATISFIABLE, 2, 31, 720, 0},
  [_FSBNDMQ31] = {_FSBNDMQ31, GOOD, ASAN, UNSATISFIABLE, 3, 31, 720, 0},
  [_FSBNDMQ32] = {_FSBNDMQ32, FAIL, FAIL, UNSATISFIABLE, 3, 30, 720, 0},
  [_FSBNDMQ41] = {_FSBNDMQ41, GOOD, ASAN, UNSATISFIABLE, 4, 31, 720, 0},
  [_FSBNDMQ42] = {_FSBNDMQ42, FAIL, FAIL, UNSATISFIABLE, 4, 30, 720, 0},
  [_FSBNDMQ43] = {_FSBNDMQ43, FAIL, FAIL, UNSATISFIABLE, 4, 29, 720, 0},
  [_FSBNDMQ61] = {_FSBNDMQ61, GOOD, ASAN, UNSATISFIABLE, 4, 0, 720, 0},
  [_FSBNDMQ62] = {_FSBNDMQ62, FAIL, FAIL, UNSATISFIABLE, 6, 0, 720, 0},
  [_FSBNDMQ64] = {_FSBNDMQ64, FAIL, FAIL, UNSATISFIABLE, 6, 0, 720, 0},
  [_FSBNDMQ81] = {_FSBNDMQ81, GOOD, ASAN, UNSATISFIABLE, 8, 0, 720, 0},
  [_FSBNDMQ82] = {_FSBNDMQ82, FAIL, FAIL, UNSATISFIABLE, 8, 0, 720, 0},
  [_FSBNDMQ84] = {_FSBNDMQ84, FAIL, FAIL, UNSATISFIABLE, 8, 0, 720, 0},
  [_FSBNDMQ86] = {_FSBNDMQ86, FAIL, FAIL, UNSATISFIABLE, 8, 0, 720, 0},
  [_IOM]   = {_IOM, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 0},
  [_JOM]   = {_JOM, GOOD, ASAN, UNSATISFIABLE, 2, 0, 256, 0},
  [_LWFR2] = {_LWFR2, GOOD, ASAN, UNSATISFIABLE, 2, 0, 720, 0},
  [_LWFR3] = {_LWFR3, GOOD, ASAN, UNSATISFIABLE, 3, 0, 720, 0},
  [_LWFR4] = {_LWFR4, GOOD, ASAN, UNSATISFIABLE, 4, 0, 720, 0},
  [_LWFR5] = {_LWFR5, GOOD, ASAN, UNSATISFIABLE, 5, 0, 720, 0},
  [_LWFR6] = {_LWFR6, GOOD, ASAN, UNSATISFIABLE, 6, 0, 720, 0},
  [_LWFR7] = {_LWFR7, GOOD, ASAN, UNSATISFIABLE, 7, 0, 720, 0},
  [_LWFR8] = {_LWFR8, GOOD, ASAN, UNSATISFIABLE, 8, 0, 720, 0},
  [_QF23] = {_QF23, GOOD, ASAN, UNSATISFIABLE, 3, 0, 360, 0},
  [_QF24] = {_QF24, GOOD, ASAN, UNSATISFIABLE, 3, 0, 360, 0},
  [_QF26] = {_QF26, GOOD, ASAN, UNSATISFIABLE, 3, 0, 360, 0},
  [_QF28] = {_QF28, GOOD, ASAN, UNSATISFIABLE, 3, 0, 360, 0},
  [_QF33] = {_QF33, GOOD, ASAN, UNSATISFIABLE, 4, 0, 360, 0},
  [_QF34] = {_QF34, GOOD, ASAN, UNSATISFIABLE, 4, 0, 360, 0},
  [_QF36] = {_QF36, GOOD, ASAN, UNSATISFIABLE, 4, 0, 360, 0},
  [_QF42] = {_QF42, GOOD, ASAN, UNSATISFIABLE, 5, 0, 360, 0},
  [_QF43] = {_QF43, GOOD, ASAN, UNSATISFIABLE, 5, 0, 360, 0},
  [_QF44] = {_QF44, GOOD, ASAN, UNSATISFIABLE, 5, 0, 360, 0},
  [_QF53] = {_QF53, GOOD, ASAN, UNSATISFIABLE, 6, 0, 360, 0},
  [_QF62] = {_QF62, GOOD, ASAN, UNSATISFIABLE, 7, 0, 360, 0},
  [_QF63] = {_QF63, GOOD, ASAN, UNSATISFIABLE, 7, 0, 360, 0},
  [_QF72] = {_QF72, GOOD, ASAN, UNSATISFIABLE, 8, 0, 360, 0},
  [_QF82] = {_QF82, GOOD, ASAN, VFY_PASS, 9, 0, 360, 256},
  [_QLQS] = {_QLQS, GOOD, ASAN, VFY_PASS, 0, 0, 360, 256},
  ...
  [_TSA]    = {_TSA, GOOD, ASAN, VFY_TIMEOUT, 2, 0, 256, 0},
  [_TSA_Q2] = {_TSA_Q2, FAIL, ASAN, VFY_TIMEOUT, 2, 64, 256, 0},
  [_TSO5]   = {_TSO5, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 0},
  ...
  [_BRAM3] = {_BRAM3, GOOD, ASAN, VFY_PASS, 0, 0, 720, 0},
  [_BRAM5] = {_BRAM5, GOOD, ASAN, VFY_PASS, 0, 0, 720, 0},
  [_BRAM7] = {_BRAM7, GOOD, ASAN, VFY_PASS, 0, 0, 720, 0},
  [_FT3]  = {_FT3, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  //[_HPBM] = {_HPBM, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  [_SSECP] = {_SSECP, FAIL, ASAN, VFY_FAIL, 0, 0, 720, 0}, // no cbmc simd support yet
  [_LIBC]  = {_LIBC, FAIL, FAIL, VFY_FAIL, 0, 0, 720, 0}, // no \0
  [_MUSL]  = {_MUSL, FAIL, ASAN, VFY_FAIL, 0, 0, 720, 0}, // no \0
  [_LIBC1] = {_LIBC1, GOOD, GOOD, VFY_FAIL, 0, 0, 720, 0},
  [_MUSL1] = {_MUSL1, GOOD, GOOD, VFY_PASS, 0, 0, 720, 0},
  [_SIMDKR] = {_SIMDKR, FAIL, RNDCRASH, VFY_FAIL, 0, 0, 720, 0}, // no cbmc simd support yet
  [_EPSM]  = {_EPSM, GOOD, FAIL, VFY_TIMEOUT, 0, 0, 720, 0}, // no cbmc simd support yet
    // clang-format on
};
