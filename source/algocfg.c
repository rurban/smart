...
const struct algocfg ALGOCFGS[] = {
  ...
  [_GS] = {_GS, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 256},
  ...
  [_ILDM1] = {_ILDM1, GOOD, ASAN, VFY_TIMEOUT, 0, 0, 256, 256},
  ...
  [_BSDM4] = {_BSDM4, GOOD, ASAN, VFY_TIMEOUT, 4, 0, 256, 256},
  ...
  [_FSBNDMQ32] = {_FSBNDMQ32, FAIL, FAIL, UNSATISFIABLE, 3, 30, 720, 256},
  [_FSBNDMQ41] = {_FSBNDMQ41, GOOD, ASAN, UNSATISFIABLE, 4, 31, 720, 256},
  [_FSBNDMQ42] = {_FSBNDMQ42, FAIL, FAIL, UNSATISFIABLE, 4, 30, 720, 256},
  [_FSBNDMQ43] = {_FSBNDMQ43, FAIL, FAIL, UNSATISFIABLE, 4, 29, 720, 256},
  [_FSBNDMQ61] = {_FSBNDMQ61, GOOD, ASAN, UNSATISFIABLE, 4, 0, 720, 256},
  [_FSBNDMQ62] = {_FSBNDMQ62, FAIL, FAIL, UNSATISFIABLE, 6, 0, 720, 256},
  [_FSBNDMQ64] = {_FSBNDMQ64, FAIL, FAIL, UNSATISFIABLE, 6, 0, 720, 256},
  [_FSBNDMQ81] = {_FSBNDMQ81, GOOD, ASAN, UNSATISFIABLE, 8, 0, 720, 256},
  [_FSBNDMQ82] = {_FSBNDMQ82, FAIL, FAIL, UNSATISFIABLE, 8, 0, 720, 256},
  [_FSBNDMQ84] = {_FSBNDMQ84, FAIL, FAIL, UNSATISFIABLE, 8, 0, 720, 256},
  [_FSBNDMQ86] = {_FSBNDMQ86, FAIL, FAIL, UNSATISFIABLE, 8, 0, 720, 256},
  [_IOM]   = {_IOM, GOOD, ASAN, UNSATISFIABLE, 0, 0, 256, 256},
  [_JOM]   = {_JOM, GOOD, ASAN, UNSATISFIABLE, 2, 0, 256, 256},
