...
const struct algocfg ALGOCFGS[] = {
  ...
  [_SMOA] = {_SMOA, GOOD, ASAN, VFY_FAIL, 0, 0, 256, 256},
  ...
  [_ILDM2] = {_ILDM2, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
  ...
  [_BNDMq6] = {_BNDMq6, GOOD, ASAN, UNSATISFIABLE, 6, 0, 256, 256},
  ...
  [_BSDM7] = {_BSDM7, GOOD, ASAN, UNSATISFIABLE, 7, 0, 256, 256},
  ...
  [_TVSBS_W2] = {_TVSBS_W2, GOOD, ASAN, VFY_PASS, 0, 0, 256, 256},
