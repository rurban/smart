...
const struct algocfg ALGOCFGS[] = {
  ...
  [_AC] = {_AC, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  ...
  [_RColussi] = {_RColussi, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_Skip] = {_Skip, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_KMPSkip] = {_KMPSkip, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_ASkip] = {_ASkip, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_BR] = {_BR, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_AKC] = {_AKC, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  ...
  [_TVSBS] = {_TVSBS, GOOD, FAIL, VFY_PASS, 0, 0, 0, 0, 0, 0},
  ...
  [_HASH3] = {_HASH3, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_HASH5] = {_HASH5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_HASH8] = {_HASH8, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  ...
  [_GRASPm] = {_GRASPm, FAIL, FAIL, VFY_PASS, 0, 0, 0, 0, 0, 0},
  ...
  [_AOSO2] = {_AOSO2, GOOD, ASAN, VFY_PASS, 3, 0, 0, 0, 0, 0},
  [_AOSO4] = {_AOSO4, GOOD, ASAN, VFY_PASS, 5, 0, 0, 0, 0, 0},
  [_AOSO6] = {_AOSO6, GOOD, ASAN, VFY_PASS, 7, 0, 0, 0, 0, 0},
  ...
  [_BNDMq4] = {_BNDMq4, GOOD, FAIL, VFY_PASS, 4, 0, 0, 0, 0, 0},
  [_BNDMq6] = {_BNDMq6, GOOD, FAIL, VFY_PASS, 6, 0, 0, 0, 0, 0},
  ...
  [_FS_W6] = {_FS_W6, GOOD, ASAN, VFY_PASS, 8, 0, 0, 0, 0, 0}, // n>=8
  [_FS_W8] = {_FS_W8, FAIL, ASAN, VFY_PASS, 10, 0, 0, 0, 0, 0},
  ...
  [_FSBNDMQ61] = {_FSBNDMQ61, GOOD, ASAN, VFY_PASS, 4, 0, 0, 0, 0, 0},
  [_FSBNDMQ62] = {_FSBNDMQ62, FAIL, FAIL, VFY_PASS, 6, 0, 0, 0, 0, 0},
  [_FSBNDMQ64] = {_FSBNDMQ64, FAIL, FAIL, VFY_PASS, 6, 0, 0, 0, 0, 0},
  [_FSBNDMQ81] = {_FSBNDMQ81, GOOD, ASAN, VFY_PASS, 8, 0, 0, 0, 0, 0},
  [_FSBNDMQ82] = {_FSBNDMQ82, FAIL, FAIL, VFY_PASS, 8, 0, 0, 0, 0, 0},
  [_FSBNDMQ84] = {_FSBNDMQ84, FAIL, FAIL, VFY_PASS, 8, 0, 0, 0, 0, 0},
  [_FSBNDMQ86] = {_FSBNDMQ86, FAIL, FAIL, VFY_PASS, 8, 0, 0, 0, 0, 0},
  [_IOM]   = {_IOM, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_JOM]   = {_JOM, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR2] = {_LWFR2, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR3] = {_LWFR3, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR4] = {_LWFR4, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR5] = {_LWFR5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR6] = {_LWFR6, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR7] = {_LWFR7, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_LWFR8] = {_LWFR8, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  ...
  [_SBNDM_W2] = {_SBNDM_W2, FAIL, FAIL, VFY_PASS, 2, 0, 0, 0, 0, 0},
  [_SBNDM_W4] = {_SBNDM_W4, FAIL, FAIL, VFY_PASS, 4, 0, 0, 0, 0, 0},
  [_SBNDM_W6] = {_SBNDM_W6, GOOD, FAIL, VFY_PASS, 6, 0, 0, 0, 0, 0},
  [_SSM]    = {_SSM, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TSA]    = {_TSA, ASSERTS, FAIL, VFY_PASS, 2, 0, 0, 0, 0, 0},
  [_TSA_Q2] = {_TSA_Q2, FAIL, ASAN, VFY_PASS, 2, 64, 0, 0, 0, 0},
  [_TSO5]   = {_TSO5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TUNEDBM] = {_TUNEDBM, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TVSBS_W2] = {_TVSBS_W2, GOOD, FAIL, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TVSBS_W4] = {_TVSBS_W4, FAIL, FAIL, VFY_PASS, 2, 0, 0, 0, 0, 0},
  [_TVSBS_W6] = {_TVSBS_W6, GOOD, FAIL, VFY_PASS, 2, 0, 0, 0, 0, 0},
  [_TVSBS_W8] = {_TVSBS_W8, FAIL, FAIL, VFY_PASS, 2, 0, 0, 0, 0, 0},
  [_WFR]  = {_WFR,  GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR2] = {_WFR2, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR3] = {_WFR3, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR4] = {_WFR4, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR5] = {_WFR5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR6] = {_WFR6, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR7] = {_WFR7, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFR8] = {_WFR8, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ2] = {_WFRQ2, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ3] = {_WFRQ3, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ4] = {_WFRQ4, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ5] = {_WFRQ5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ6] = {_WFRQ6, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ7] = {_WFRQ7, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WFRQ8] = {_WFRQ8, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR]  = {_TWFR,  GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR2] = {_TWFR2, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR3] = {_TWFR3, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR4] = {_TWFR4, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR5] = {_TWFR5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR6] = {_TWFR6, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR7] = {_TWFR7, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFR8] = {_TWFR8, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ2] = {_TWFRQ2, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ3] = {_TWFRQ3, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ4] = {_TWFRQ4, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ5] = {_TWFRQ5, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ6] = {_TWFRQ6, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ7] = {_TWFRQ7, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_TWFRQ8] = {_TWFRQ8, GOOD, ASAN, VFY_PASS, 0, 0, 0, 0, 0, 0},
  [_WC]     = {_WC,     GOOD, ASAN, VFY_FAIL, 0, 0, 0, 0, 0, 0},
  [_WOM]    = {_WOM,    GOOD, ASAN, VFY_FAIL, 0, 0, 0, 0, 0, 0},
  [_DOUBLEHASH] = {_DOUBLEHASH, GOOD, ASAN, VFY_FAIL, 0, 0, 0, 0, 0, 0},
  [_BRAM3] = {_BRAM3, GOOD, ASAN, VFY_FAIL, 3, 0, 0, 0, 0, 0},
  [_BRAM5] = {_BRAM5, GOOD, ASAN, VFY_FAIL, 5, 0, 0, 0, 0, 0},
  [_BRAM7] = {_BRAM7, GOOD, ASAN, VFY_FAIL, 7, 0, 0, 0, 0, 0},
