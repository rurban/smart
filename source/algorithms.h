...
enum algo_id {
  ...
  _FHC4,   // Fast HashChain Q=4
  _FHC5,   // Fast HashChain Q=5
  _FHC6,   // Fast HashChain Q=6
  _FHC7,   // Fast HashChain Q=7
  _FHC8,   // Fast HashChain Q=8
} ALGO_POS;
...
const struct algo ALGOS[] = {
  ...
  [_LDM] = {_LDM, OK, "ldm", "Linear DAWG Matching", 0, 0},
  ...
  [_SBDM] = {_SBDM, OK, "sbdm", "Succinct Backward DAWG Matching", 0, 0},
  [_BSOM] = {_BSOM, OK, "bsom", "Backward Set Oracle Matching", 0, 0},
  ...
  [_FAOSO6] = {_FAOSO6, OK, "faoso6", "fast average optimal shift-or (u=2,m>6)", 7, 0},
  ...
  [_BXS] = {_BXS, OK, "bxs", "BNDMq with eXtended Shift", 2, 0},
  ...
  [_SIMDKR] = {_SIMDKR, OK, "simdkr", "SIMD generic Rabin-Karp variants (SSE4/AVX2/NEON)", 2, 0}, // improved
  [_KRSIMD] = {_KRSIMD, OK, "krsimd", "Polynomial SIMD Rabin-Karp (AVX2)", 0, 0},
  [_EPSM] = {_EPSM, SIMD128_ONLY, "epsm", "Exact Packed String Matching (SSE4/AVX2/NEON)", 0, 0},
  ...
  [_HC8] = {_HC8, OK  , "hc8", "HashChain q=8", 8, 0},
  ...
  [_LHC4] = {_LHC4, OK  , "lhc4", "Linear HashChain q=4", 4, 0},
  [_LHC5] = {_LHC5, OK  , "lhc5", "Linear HashChain q=5", 5, 0},
  [_LHC6] = {_LHC6, OK  , "lhc6", "Linear HashChain q=6", 6, 0},
  [_LHC7] = {_LHC7, OK  , "lhc7", "Linear HashChain q=7", 7, 0},
  [_LHC8] = {_LHC8, OK  , "lhc8", "Linear HashChain q=8", 8, 0},
  ...
  [_SHC4] = {_SHC4, OK  , "shc4", "Sentinel HashChain q=4", 4, 0},
  [_SHC5] = {_SHC5, OK  , "shc5", "Sentinel HashChain q=5", 5, 0},
  [_SHC6] = {_SHC6, OK  , "shc6", "Sentinel HashChain q=6", 6, 0},
  [_SHC7] = {_SHC7, OK  , "shc7", "Sentinel HashChain q=7", 7, 0},
  [_SHC8] = {_SHC8, OK  , "shc8", "Sentinel HashChain q=8", 8, 0},
  ...
  [_FHC4] = {_FHC4, OK  , "fhc4", "Fast HashChain q=4", 4, 0},
  [_FHC5] = {_FHC5, OK  , "fhc5", "Fast HashChain q=5", 5, 0},
  [_FHC6] = {_FHC6, OK  , "fhc6", "Fast HashChain q=6", 6, 0},
  [_FHC7] = {_FHC7, OK  , "fhc7", "Fast HashChain q=7", 7, 0},
  [_FHC8] = {_FHC8, OK  , "fhc8", "Fast HashChain q=8", 8, 0},
    // clang-format on
};
